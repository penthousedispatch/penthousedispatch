/*
  ...
  On legacy Bolt-created projects, some of these tables already existed.
  On fresh installs from this repo, several optional/legacy tables may not.
  This migration now skips missing tables/columns instead of failing.
*/
