...
export default function PayoutsTab({ embedded = false }) {
  ...
  return (
    ...
    >
      <div className="px-4 sm:px-6 py-4 border-b flex-shrink-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" style={{ borderColor: 'rgba(255,255,255,0.07)' }}>
        <div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 sm:px-6 mb-3 flex items-center gap-2 flex-wrap">
