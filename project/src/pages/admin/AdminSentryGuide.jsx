...
const STEPS = [
  ...
  },
  {
    ...
    substeps: [
      ...
      'You can also test rejection: POST /trips/{id}/reject. A rejected broker trip should read back with acceptance_status_id=0 while lifecycle status_id stays on the last broker lifecycle step.',
    ],
